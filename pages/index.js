  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Explore unforgettable travel deals, family vacations, and adventure escapes with WanderWise."
        />
      ...
      <main className="min-h-screen bg-white text-gray-800 font-sans">
        ...
        <section className="py-12 px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: "Family Adventures", image: "/images/family.jpg", link: "/deals/family" },
              { title: "Couples Escapes", image: "/images/couples.jpg", link: "/deals/couples" },
              { title: "Adventure Travel", image: "/images/adventure.jpg", link: "/deals/adventure" },
              { title: "Deals", image: "/images/deals.jpg", link: "/deals" },
            ].map((deal) => (
